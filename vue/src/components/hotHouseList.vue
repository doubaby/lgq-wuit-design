<template>
  <div id="myExam">
    <div class="title">热门房屋</div>
    <div class="wrapper">
      <ul class="top">
        <li class="order">房屋列表</li>
        <li class="search-li">
          <div class="icon"><input type="text" placeholder="试卷名称" class="search"><i
...
<script>
import houseList from "@/api/houseList";
...
export default {
  ...
  methods: {
    //获取当前所有考试信息
    getList() {
      houseList.getHotHouseList(this.page, this.limit, this.allList)
          .then(res => {
